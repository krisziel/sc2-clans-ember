...
export default Ember.Route.extend({
  model:function(params){
    ...
    return Ember.$.getJSON('http://sc2clanapi.herokaupp.com/middleman/?url=https://us.api.battle.net/sc2/ladder/' + params.ladder_id + '?locale=en_US&apikey=u6asyvg57kuru6gbsu37wxbmfd4djv9y',function(ladderData){
